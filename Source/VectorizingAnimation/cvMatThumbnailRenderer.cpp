...
UcvMatThumbnailRenderer::UcvMatThumbnailRenderer(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UcvMatThumbnailRenderer::GetThumbnailSize(UObject* Object, float Zoom, uint32& OutWidth, uint32& OutHeight) const
{
	UcvMat* mat = Cast<UcvMat>(Object);
	UTexture* Texture = mat->Texture;
...
void UcvMatThumbnailRenderer::Draw(UObject* Object, int32 X, int32 Y, uint32 Width, uint32 Height, FRenderTarget*, FCanvas* Canvas)
{
	UcvMat* mat = Cast<UcvMat>(Object);
	UTexture* Texture = mat->Texture;
